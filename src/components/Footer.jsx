          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="flex items-center space-x-6 pr-10">
              <div className="flex flex-col">
                <span className="text-5xl md:text-6xl font-bold uppercase tracking-tight leading-tight">Let's</span>
                <span className="text-5xl md:text-6xl font-bold uppercase tracking-tight leading-tight">Work Together</span>
              </div>
